...
public class CambioCierreController {
    ...
    private void setCards() {
        cardAccessArrangements[0] = CardAccessArrangement.builder().cardNum("3778040002377760")
                ...
                .primAcctInfo(AccountArrangement.builder().acctShrtSLName("HSBC BANK ARGENTINA").soleJointCde("0")
                        .restrCde("7").statCde("4").restrDesc("AMERICAN EXPRESS").statDesc("OPERATIVA").build())
                .build();
        cardAccessArrangements[1] = CardAccessArrangement.builder().cardNum("5360873721102328")
                .cardhName("STEFANOLO ESTELA N").typeIdfcCde("DNI").idfcNum("10266305")
                .primAcctInfo(AccountArrangement.builder().acctShrtSLName("HSBC BANK ARGENTINA").soleJointCde("0")
                        .restrCde("1").statCde("4").restrDesc("MASTERCARD").statDesc("OPERATIVA").build())
                .build();
        cardAccessArrangements[2] = CardAccessArrangement.builder().cardNum("53608727560669766")
                ...
                .cycLmtPurchAmt(GSMAmount.builder().amt(BigDecimal.valueOf(0.0)).build()).typeIdfcCde("DNI")
                .idfcNum("10129290")
                .acctAccessCard(AccountAccessCard.builder().issCde("4").ofstPINNum("11002001133387")
                        .userSLName("113338729").build())
                .primAcctInfo(AccountArrangement.builder().acctShrtSLName("").soleJointCde("2").restrCde("1")
                        .statCde("4").restrDesc("MASTERCARD").statDesc("OPERATIVA").build())
                .build();
